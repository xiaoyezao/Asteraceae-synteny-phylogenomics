...
namespace SyntenyFast
{
    internal static class Program
    {
        ...
        private static void Main(string[] args)
        {
            ...
            if (args.Length != 4)
            {
                Console.Out.Write("\nDRIMM-Synteny v1.0.0\nDecomposing genomes into evolutionary conserved segments\n\nUsage: mono DRIMM-Synteny cycleLengthThreshold dustLengthThreshold inFile outDir\n\n");
                return;
            }
